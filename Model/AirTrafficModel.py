...
class AirTrafficModel(Model):
    ...
    def step(self):
        if(self._steps < self.tiempo_simulacion):
            ...
            for airport in self.schedule.get_agents_by_type("Airport"):
                if airport.airstrips > max_airstrips:
                    max_airstrips = airport.airstrips
                if airport.airstrips < min_airstrips:
                    min_airstrips = airport.airstrips
                mean_airstrips += airport.airstrips
            ...
            print(f"""
                  ...
                  Dimensiones de la cuadrícula: {self.grid[0]} x {self.grid[0]}
