...
if __name__ == "__main__":
    ...
    server = AirTrafficServer(AirTrafficModel, tam_cuadricula=70, tiempo_simulacion=1000, num_airports=10, 
                              num_planes=50, max_num_aisrstrips=5, max_plane_speed=5, tiempo_entre_despegues_aterrizajes=5, max_time_waiting=5)
    server.launch()
